...
class RegistrationCtl(Basectl):
    ...
    def request_to_form(self, requestForm):
        ...
        print("loginid",self.form["loginId"])
    ...
    def form_to_model(self, obj):
        ...
        obj.loginId = self.form.get("loginId", "")
    ...
    def input_validation(self):
        ...
        if DataValidator.isNull(self.form.get("loginId")):
            ...
            self.form["error"] = True
        elif not DataValidator.isemail(self.form.get("loginId")):
            inputError["loginId"] = "Login must be a valid email address"
            self.form["error"] = True
